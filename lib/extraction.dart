...
class ExtractedInfo {
  ...
  final String dateOfBirth; // YYYY-MM-DD or empty
  final String nationality; // 2 or 3-letter code or empty
...
ExtractedInfo? parseMRZ(String text) {
  final lines = text
      .split(RegExp(r'[\r\n]+'))
...
/// Heuristic parsing for non-MRZ IDs using OCR text
ExtractedInfo parseHeuristics(String text) {
